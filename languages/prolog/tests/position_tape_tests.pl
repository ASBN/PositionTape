...
main :-
    ...
    locate(Fragment, 30),
    hash_fragment("", EmptyHash),
    assert_true(EmptyHash == e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855, 'sha256 empty'),
    hash_fragment("abc", AbcHash),
    assert_true(AbcHash == ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad, 'sha256 abc'),
