...
- Language: SQLite SQL
- Runtime/compiler: `sqlite3` 3.53.2 available on PATH in this checkpoint.
...
- Hash index: Not implemented; the verified SQLite 3.53.2 binary exposes `sha3()` but not exact `sha256()`.
