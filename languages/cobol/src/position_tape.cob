       ...
       PROGRAM-ID. POSITION-TAPE.

       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 ARG-LENGTH              PIC X(16).
       01 REQUESTED-LENGTH        PIC 9(9) COMP VALUE 0.
       ...
       PROCEDURE DIVISION.
       MAIN.
           ACCEPT ARG-LENGTH FROM ARGUMENT-VALUE
           MOVE FUNCTION NUMVAL(ARG-LENGTH) TO REQUESTED-LENGTH
           PERFORM UNTIL WRITTEN >= REQUESTED-LENGTH
               ...
               END-IF
           END-PERFORM
           DISPLAY OUTPUT-TEXT(1:REQUESTED-LENGTH) WITH NO ADVANCING
           STOP RUN.
